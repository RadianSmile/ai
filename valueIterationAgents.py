...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        ### run value iteration for `iterations` times
        for i in range(self.iterations):

          ### calculate each value of states
          ...
          for state in states:
            ...
            for action in self.mdp.getPossibleActions(state):
              ...
              # q value of (state , action) is derived from
              q_value = self.computeQValueFromValues(state, action)
              if q_value > max_val:
                max_val = q_value

              # the value of state is the max q value
              # this value comes from `computeQValueFromValues`
